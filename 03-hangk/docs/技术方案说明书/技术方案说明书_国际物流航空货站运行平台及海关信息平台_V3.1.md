...
| 环境组件 | 技术选型/配置要求 |
|----------|------------------|
| 数据库环境： | MySQL 8.0 / PostgreSQL 14，主从架构，读写分离 |
| 消息中间件： | RabbitMQ / Apache Kafka，集群部署，高可用 |
| Java虚拟机： | JDK 17，内存配置4G-8G，G1垃圾回收器 |
| 服务注册中心： | Nacos 2.x，集群部署，服务发现与配置管理 |
| 数据缓存组件： | Redis 6.x，集群模式，主从+哨兵 |
| 开发框架： | Spring Boot 3.x + Spring Cloud Alibaba |
| 开发技术： | Java 17、Vue3、MyBatis-Plus、Docker、Kubernetes |
