class LowcodeComponent extends Component {
  ...
  static PAGE_FORMCODE = 'MES_weixinsaomiaosuyuan';
  static PAGE_FORMNAME = '微信扫码溯源';
  ...
  renderProductInfo() {
    ...
    const { Card, Descriptions } = window.antd;
  ...
  renderQualityInfo() {
    const { traceData } = this.state;
    const { Card, Row, Col } = window.antd;
  ...
  renderError() {
    ...
    const { Result, Button } = window.antd;
